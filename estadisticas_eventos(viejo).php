...
and e.id not in (528, 949, 2051, 2052, 3007, 3019)");
	...
	<div class="row">
			<div class="col-md-R col-sm-6">
					<!-- BEGIN PORTLET-->
					<div class="portlet">
							<div class="portlet blue box">
													<div class="portlet-title">
														<div class="caption">
															<i class="glyphicon glyphicon-list-alt""></i>Asistentes Eventos Presenciales VALENCIA
														</div>
														<div class="tools">
        ...
        <div class="col-md-R col-sm-6">
            ...
            <div class="portlet">
                <div class="portlet blue box">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="glyphicon glyphicon-list-alt""></i>Asistentes Eventos Presenciales CARACAS
                        </div>
                        <div class="tools">
                            <a href="javascript:" class="expand">
                            </a>
...
left join eventos e on e.id = r.id_eventos
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP)-2 and e.visible=1 and e.pais='ve' and e.modalidad='presencial' and l.zona='caracas' and r.del_id is null and a.asistencia=1 and r.status>=2 and e.tipo<>'Diplomado'
and e.id not in (528, 949, 2051, 2052, 3007, 3019)
group by year(e.fecha_1), MONTH(e.fecha_1)
");
...
left join eventos e on e.id = r.id_eventos
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP)-1 and e.visible=1 and e.pais='ve' and e.modalidad='presencial' and l.zona='caracas' and r.del_id is null and a.asistencia=1 and r.status>=2 and e.tipo<>'Diplomado'
and e.id not in (528, 949, 2051, 2052, 3007, 3019)
group by year(e.fecha_1), MONTH(e.fecha_1)
");
...
left join eventos e on e.id = r.id_eventos
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP) and e.visible=1 and e.pais='ve' and e.modalidad='presencial' and l.zona='caracas' and r.del_id is null and a.asistencia=1 and r.status>=2 and e.tipo<>'Diplomado'
and e.id not in (528, 949, 2051, 2052, 3007, 3019)
group by year(e.fecha_1), MONTH(e.fecha_1)
");
                    $ano1=array();
        ...
        <div class="col-md-R col-sm-6">
            ...
            <div class="portlet">
                <div class="portlet blue box">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="glyphicon glyphicon-list-alt""></i>Asistentes Eventos ONLINE
                        </div>
                        <div class="tools">
                            <a href="javascript:" class="expand">
                            </a>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="portlet">
                    <div class="portlet grey box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="glyphicon glyphicon-list-alt""></i>Cantidad de Eventos VALENCIA
                            </div>
                            <div class="tools">
                                <a href="javascript:" class="expand">
                                </a>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="portlet">
                    <div class="portlet grey box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="glyphicon glyphicon-list-alt""></i>Cantidad de Eventos CARACAS
                            </div>
                            <div class="tools">
                                <a href="javascript:" class="expand">
                                </a>
...
FROM eventos e
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP)-2 and e.visible = '1' and e.modalidad='presencial' and e.pais='ve' and l.zona='caracas' and e.id not in (528, 949, 2051, 2052, 3007, 3019) and e.tipo<>'Diplomado'
group by year(e.fecha_1), MONTH(e.fecha_1)
");
...
FROM eventos e
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP)-1 and e.visible = '1' and e.modalidad='presencial'  and e.pais='ve' and l.zona='caracas' and e.id not in (528, 949, 2051, 2052, 3007, 3019) and e.tipo<>'Diplomado'
group by year(e.fecha_1), MONTH(e.fecha_1)
");
...
FROM eventos e
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP) and e.visible = '1' and e.modalidad='presencial' and e.pais='ve' and l.zona='caracas' and e.id not in (528, 949, 2051, 2052, 3007, 3019) and e.tipo<>'Diplomado'
group by year(e.fecha_1), MONTH(e.fecha_1)
");
                                $ano1=array();
                                $ano2=array();
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="portlet">
                    <div class="portlet red box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="glyphicon glyphicon-list-alt""></i>Cantidad de Eventos VALENCIA (CANCELADOS)
                            </div>
                            <div class="tools">
                                <a href="javascript:" class="expand">
                                </a>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="portlet">
                    <div class="portlet red box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="glyphicon glyphicon-list-alt""></i>Cantidad de Eventos CARACAS (CANCELADOS)
                            </div>
                            <div class="tools">
                                <a href="javascript:" class="expand">
                                </a>
...
FROM eventos e
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP)-2 and e.visible = '0' and e.modalidad='presencial' and e.pais='ve' and l.zona='caracas' and e.id not in (528, 949, 2051, 2052, 3007, 3019) and e.tipo<>'Diplomado'
group by year(e.fecha_1), MONTH(e.fecha_1)
");
...
FROM eventos e
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP)-1 and e.visible = '0' and e.modalidad='presencial'  and e.pais='ve' and l.zona='caracas' and e.id not in (528, 949, 2051, 2052, 3007, 3019) and e.tipo<>'Diplomado'
group by year(e.fecha_1), MONTH(e.fecha_1)
");
...
FROM eventos e
left JOIN lugares l on l.id = e.lugar_id
where year(e.fecha_1)=YEAR(CURRENT_TIMESTAMP) and e.visible = '0' and e.modalidad='presencial' and e.pais='ve' and l.zona='caracas' and e.id not in (528, 949, 2051, 2052, 3007, 3019) and e.tipo<>'Diplomado'
group by year(e.fecha_1), MONTH(e.fecha_1)
");
                                $ano1=array();
                                $ano2=array();
