...
if (isset($_SESSION['usuario']) && $_SESSION['usuario'] == "rober")
{
...
<div class="content">
	...
	<form class="login-form" action="validar.php" method="post">
		...
		<div class="alert alert-danger display-hide">
			...
			<span>
				 Introduce Nombre de Usuario y Clave.
			</span>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="nombre de usuario" name="usuario"/>
			</div>
		</div>
		<div class="form-group">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2014 &copy; Roberto Fernandez. - Administrador Estadistico / ZONA DE INICIO DE SESION.
</div>
<!-- END COPYRIGHT -->
