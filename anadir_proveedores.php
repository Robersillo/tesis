		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Ventas y Compras <small>Panel de Proveedores (añadir)</small>
					</h3>
				...
				<div class="col-md-12">
						<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Añadir Proveedores
										</div>
										<div class="tools">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="proveedores_anadidos.php" method="post" id="form_sample_1" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Nombre de Empresa
										<span class="required">
											 *
										</span>
                                            </label>
										...
										<span class="required">
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control" name="category3" class="select2me">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Persona de Contacto
										<span class="required">
											 *
										</span>
                                            </label>
                                            <div class="col-md-4">
                                                <input type="text" name="contacto" data-required="1" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Cargo en la Empresa
										<span class="required">
											 *
										</span>
                                            </label>
                                            <div class="col-md-4">
                                                <input type="text" name="cargo" data-required="1" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Tipo de Pago
										<span class="required">
											 *
										</span>
                                            </label>
                                            <div class="col-md-4">
                                                <select class="form-control" name="category1" class="select2me">
                                                    <option value="">Select...</option>
                                                    <option value="Pago (Transferencia o Efectivo)">Pago (Transferencia o Efectivo)</option>
                                                    <option value="Intercambio">Intercambio</option>
                                                    <option value="Intercambio/Pago">Intercambio/Pago</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Tipo de Servicio
										<span class="required">
											 *
										</span>
                                            </label>
                                            <div class="col-md-4">
                                                <select class="form-control" name="category2" class="select2me">
                                                    <option value="">Select...</option>
                                                    <option value="Publicidad Television">Publicidad Television</option>
                                                    <option value="Publicidad Vallas">Publicidad Vallas</option>
                                                    <option value="Publicidad Radio">Publicidad Radio</option>
                                                    <option value="Publicidad Prensa">Publicidad Prensa</option>
                                                    <option value="Impresion Material">Impresion Material</option>
